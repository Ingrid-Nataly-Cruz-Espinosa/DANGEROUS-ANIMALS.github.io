...
const notification = new Notification("Recorre el mundo de una forma mas segura", {
    body: "Recuerda que las montañas y bosques, son habitas para animales salvajes",
    icon: "/icono.png",
    timeout: 1500000,
    vibrate: [100, 100, 100],
    onClick: function(){
